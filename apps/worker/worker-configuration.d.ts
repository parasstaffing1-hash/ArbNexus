/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 6af9a58322dde51f6dc63c24b41e2ec6)
// Runtime types generated with workerd@1.20260916.1 2026-03-01 nodejs_compat
interface __BaseEnv_Env {
  ASSETS: Fetcher;
  ENVIRONMENT: 'production';
  ENABLE_EXECUTION: 'false';
  AIVEN_HOST: 'pg-1637aba4-arbnexus4-d8f9.h.aivencloud.com';
  AIVEN_PORT: '19907';
  PLATFORM_NAME: 'ArbNexus Intelligence';
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      Cloudflare.Env,
      'ENVIRONMENT' | 'ENABLE_EXECUTION' | 'AIVEN_HOST' | 'AIVEN_PORT' | 'PLATFORM_NAME'
    >
  > {}
}
